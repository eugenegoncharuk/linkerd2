...
| cniPlugin.image.name | string | `"cr.l5d.io/linkerd/cni-plugin"` | Docker image for the cni-plugin container |
| cniPlugin.image.pullPolicy | string | imagePullPolicy | Pull policy for the cni-plugin container Docker image |
| cni-plugin.image.version | string | `"v1.0.0"` | Tag for the cni-plugin container Docker image |
